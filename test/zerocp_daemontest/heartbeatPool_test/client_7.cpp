...
int main()
{
    ...
    ZEROCP_LOG(Info, "Client_7 starting (PID: " << getpid() << ")");
    
    ZeroCP::Runtime::RuntimeName_t runtimeName;
    runtimeName.insert(0, "Client_7");
    ...
    ZEROCP_LOG(Info, "Client_7 registered successfully");
    ...
    ZEROCP_LOG(Info, "Client_7 shutting down");
    return 0;
}

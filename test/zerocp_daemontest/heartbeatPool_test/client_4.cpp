...
int main()
{
    ...
    ZEROCP_LOG(Info, "Client_4 starting (PID: " << getpid() << ")");
    
    ZeroCP::Runtime::RuntimeName_t runtimeName;
    runtimeName.insert(0, "Client_4");
    ...
    ZEROCP_LOG(Info, "Client_4 registered successfully");
    ...
    ZEROCP_LOG(Info, "Client_4 shutting down");
    return 0;
}

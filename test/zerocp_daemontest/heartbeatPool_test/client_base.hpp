...
int runClient(const std::string& clientId)
{
    // 安装信号处理器
    ...
    ZEROCP_LOG(Info, "======================================");
    ZEROCP_LOG(Info, "Starting Heartbeat Client");
    ...
    ZEROCP_LOG(Info, "✓ Heartbeat thread running (100ms interval)");
    ...
    ZEROCP_LOG(Info, "Client " << clientId << " shutting down gracefully...");

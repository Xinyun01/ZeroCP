...
int main()
{
    ...
    ZEROCP_LOG(Info, "Client_1 starting (PID: " << getpid() << ")");
    
    ZeroCP::Runtime::RuntimeName_t runtimeName;
    runtimeName.insert(0, "Client_1");
    ...
    ZEROCP_LOG(Info, "Client_1 registered successfully");
    ...
    ZEROCP_LOG(Info, "Client_1 shutting down");
    return 0;
}

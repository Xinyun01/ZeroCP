...
int main()
{
    ...
    ZEROCP_LOG(Info, "Client_3 starting (PID: " << getpid() << ")");
    
    ZeroCP::Runtime::RuntimeName_t runtimeName;
    runtimeName.insert(0, "Client_3");
    ...
    ZEROCP_LOG(Info, "Client_3 registered successfully");
    ...
    ZEROCP_LOG(Info, "Client_3 shutting down");
    return 0;
}

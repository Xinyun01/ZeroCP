...
int main()
{
    ...
    ZEROCP_LOG(Info, "Client_8 starting (PID: " << getpid() << ")");
    
    ZeroCP::Runtime::RuntimeName_t runtimeName;
    runtimeName.insert(0, "Client_8");
    ...
    ZEROCP_LOG(Info, "Client_8 registered successfully");
    ...
    ZEROCP_LOG(Info, "Client_8 shutting down");
    return 0;
}

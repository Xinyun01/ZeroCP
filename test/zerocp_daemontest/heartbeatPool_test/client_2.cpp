...
int main()
{
    ...
    ZEROCP_LOG(Info, "Client_2 starting (PID: " << getpid() << ")");
    
    ZeroCP::Runtime::RuntimeName_t runtimeName;
    runtimeName.insert(0, "Client_2");
    ...
    ZEROCP_LOG(Info, "Client_2 registered successfully");
    ...
    ZEROCP_LOG(Info, "Client_2 shutting down");
    return 0;
}

...
int main()
{
    ...
    ZEROCP_LOG(Info, "Client_9 starting (PID: " << getpid() << ")");
    
    ZeroCP::Runtime::RuntimeName_t runtimeName;
    runtimeName.insert(0, "Client_9");
    ...
    ZEROCP_LOG(Info, "Client_9 registered successfully");
    ...
    ZEROCP_LOG(Info, "Client_9 shutting down");
    return 0;
}

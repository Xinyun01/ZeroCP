...
int main()
{
    ...
    ZEROCP_LOG(Info, "Client_6 starting (PID: " << getpid() << ")");
    
    ZeroCP::Runtime::RuntimeName_t runtimeName;
    runtimeName.insert(0, "Client_6");
    ...
    ZEROCP_LOG(Info, "Client_6 registered successfully");
    ...
    ZEROCP_LOG(Info, "Client_6 shutting down");
    return 0;
}
